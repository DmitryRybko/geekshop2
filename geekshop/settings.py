...
# amount of hours after registration when activation key expires
...
SOCIAL_AUTH_GOOGLE_OAUTH2_KEY = SOCIAL['web']['client_id']
SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET = SOCIAL['web']['client_secret']
